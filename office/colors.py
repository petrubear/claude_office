...
def init_colors():
    ...
    curses.init_pair(COLOR_WHITEBOARD, curses.COLOR_GREEN, -1)
    curses.init_pair(COLOR_COFFEE, curses.COLOR_RED, -1)
    curses.init_pair(COLOR_FURNITURE, curses.COLOR_WHITE, -1)
    curses.init_pair(COLOR_SEPARATOR, curses.COLOR_WHITE, -1)
